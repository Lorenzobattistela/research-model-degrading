...
# Load the dataset
data = load_data("sep/sp500_index")
...
train_years = np.arange(2013, 2020)  # Train from 2000 to 2019
predict_years = np.arange(2013, 2023)  # Predict from 2013 to 2020
...
results_df.to_csv("sp500_polynomial_regression_results.csv", index=False)

print("Analysis completed. Results saved to 'sp500_polynomial_regression_results.csv'.")
